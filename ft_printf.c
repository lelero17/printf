...
/*   Updated: 2025/11/02 13:33:11 by lemmerli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	ft_printf("Test 2:\nINT_MIN: %d | INT_MAX: %d | UINT_MAX: %u | 0: %d | -0: %i\n", INT_MIN, INT_MAX, 4294967295u, 0, -0);
	
// 	printf("INT_MIN: %d | INT_MAX: %d | UINT_MAX: %u | 0: %d | -0: %i\n\n", INT_MIN, INT_MAX, 4294967295u, 0, -0);

// 	ft_printf("Test 3:\nNULL string: %s | NULL pointer: %p | Hex 0: %x | Hex MAX: %X\n", (char *)NULL, NULL, 0, 4294967295u);

// 	printf("NULL string: %s | NULL pointer: %p | Hex 0: %x | Hex MAX: %X\n\n", (char *)NULL, NULL, 0, 4294967295u);
